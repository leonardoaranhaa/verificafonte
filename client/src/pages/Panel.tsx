...
export default function Panel() {
  ...
  return <div className="panel-shell">
    <aside className="panel-sidebar">
      <div className="panel-brand"><Link href="/" className="brand"><span className="brand-mark"><Fingerprint size={18} /></span><span>verifica<span>fonte</span></span></Link><span className="panel-version">EDITORIAL / 0.1</span></div>
...
function LegacyOrchestration() { return <div className="orchestration-page"><div className="queue-intro"><div className="eyebrow">Agente dedicado</div><h2>Coordene pesquisa sem terceirizar a responsabilidade.</h2><p>O desenho do VerificaFonte separa as funções: agentes podem navegar e encontrar material; o sistema registra a trilha; o editor decide o que merece publicação.</p></div><div className="orchestration-grid"><div className="orchestration-card primary"><span className="orchestration-number">01</span><Bot size={22} /><h3>Agente orquestrador</h3><p>Recebe o escopo, divide a pesquisa em tarefas e reúne os retornos para uma leitura única.</p><div className="orchestration-status"><span className="live-dot"></span> Papel definido · aguardando fontes autorizadas</div></div><div className="orchestration-card"><span className="orchestration-number">02</span><SearchIcon /><h3>Agentes de navegação</h3><p>Consultam páginas públicas e fluxos permitidos, sempre devolvendo URL, data, origem e contexto.</p><div className="orchestration-status muted">Sem ação automática nesta versão</div></div><div className="orchestration-card"><span className="orchestration-number">03</span><ShieldCheck size={22} /><h3>Barreira editorial</h3><p>O veredito e a publicação ficam fora do alcance do modelo. Uma pessoa precisa revisar e registrar a decisão.</p><div className="orchestration-status accent">Regra ativa no fluxo</div></div></div><div className="integration-note"><div className="integration-note-icon"><Send size={17} /></div><div><strong>Fontes externas autorizadas</strong><p>Conectores e APIs entram por configuração explícita, com limites de acesso, registro de consulta e possibilidade de desligamento.</p></div><button className="button button-outline button-small" onClick={() => toast("A central de integrações estará disponível na próxima etapa.")}>Ver integrações</button></div></div>; }
